...
\begin{document}
    \name{Anastasia}{Golubkova}{Web and Mobile Developer}

    \info{\faEnvelopeOpen}{\texttt{nastgol@gmail.com}}
    \info{\faPhone}{+7(915) 210-60-74}
    \info{\faMap}{Pokrovskiy boulevard, 11, Moscow, Russia}
    ...
    \doubleSkill{\faCogs}{Back-end}{Symfony \textbullet{} Flask}
    \doubleSkill{\faDatabase}{Databases}{PostgreSQL}
    \doubleSkill{\faPaintBrush}{Front-end}{Angular}
    \doubleSkill{\faCode}{Integration}{TailwindCSS}
    \doubleSkill{\faTools}{Tools}{Git \textbullet{} Docker \textbullet{} \LaTeX{}}
    \doubleSkill{\faLinux}{OS}{Fedora}
    ...
    \simpleSkill{Fast learning}
    \simpleSkill{Responsibility}
    \simpleSkill{Self-learning}
    \simpleSkill{Team work}

    \cvsection{\faGraduationCap}{Education}
    \svspace
    
    \education{Bachelor of Computer Science}{2022-2026}{HSE University - Moscow, Russia}
    ...
    \hobby{\faGamepad}{Movies, TV Shows}
    \hobby{\faShoppingCart}{Shopping}
    \hobby{\faPaw}{Pets}
    \hobby{\faChess}{Tennis}
\end{document}
